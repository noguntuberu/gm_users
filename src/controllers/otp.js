...
class OtpController extends SuperController {
    ...
    async create_record(data) {
        try {
            ...
            console.log(`[OtpController] create_record Error: ${e.message}`);
        }
    }
    ...
    async read_records(conditions, fields_to_return = '', sort_options = '', skip = 0, limit = Number.MAX_SAFE_INTEGER) {
        try {
            ...
            console.log(`[OtpController] read_records: ${e.message}`);
        }
    }
    ...
    async update_records(conditions, data_to_set) {
        try {
            ...
            console.log(`[OtpController] update_records Error: ${e.message}`);
        }
    }
    ...
    async delete_records(conditions) {
        try {
            ...
            console.log(`[OtpController] delete_records Error: ${e.message}`);
        }
    }
}
